...
1. (2008) Studio di [Pentaho](https://wiki.pentaho.com/) per una soluzione aziendale BI con gestione processi **ETL** (con KETTLE):
...
5. (2017-18) Studio Machine Learning e Deep Learning con diversi obiettivi:
  ...
  - Conversational Chatbot, Vector Spaces, Word2Vec  usando classiche librerie come NLTK, Scikit-learn e soprattutto [Gensim](https://radimrehurek.com/gensim/about.html) utilizzando anche Dataset e Corpora in italiano .
