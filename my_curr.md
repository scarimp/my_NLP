...
2. (2014) Creazione di un'**ontologia** dell'anagrafe delle scuole italiane e sua interrogazione [agli endpoint](https://dydra.com/dyd_fra/scuole-pubbliche9) tramite **Sparql**. Questa applicazione è stata sviluppato con una serie di tools tra cui [Openrefine](http://openrefine.org/download.html) e un plug-in sviluppato da [DERI](https://github.com/fadmaa/grefine-rdf-extension/downloads). 
